      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          ...
          className={`p-4 rounded-xl border-2 transition-all ${
            splitMode === "EQUAL" ? "border-primary bg-primary/10" : "border-base-300 hover:border-base-100"
          }`}
        >
        ...
        <button
          ...
          className={`p-4 rounded-xl border-2 transition-all ${
            splitMode === "UNEQUAL" ? "border-primary bg-primary/10" : "border-base-300 hover:border-base-100"
          }`}
        >
          <div className="flex items-center justify-center mb-2">
